...
# Data set --------------------------------------------------------------------
getSymbols("BTC-CAD", src = 'yahoo',from = "2017-01-01")
...
#ACF & PACF
par(mfrow = c(2,1))
acf(BTC_close,lag.max=2000,type="correlation",main="ACF")
acf(BTC_close, lag.max=50,type="partial",main="PACF")
